...
interface ConfirmedUser extends IUser {
	isActive: boolean;
}

interface IAdmin extends ConfirmedUser {
	adminSince: Date;
}
export class AccountManager {
   ...
   */
	activateNewUser(approver: IAdmin, userToApprove: ConfirmedUser): ConfirmedUser {
   ...
   */
	promoteToAdmin(existingAdmin: IAdmin, user: IAdmin): IAdmin {
